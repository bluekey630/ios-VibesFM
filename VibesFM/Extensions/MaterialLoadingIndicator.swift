...
class MaterialLoadingIndicator: UIView {
    ...
    private func startColorAnimation() {
        ...
        color.duration = 10.0
        color.values   = [UIColor(netHex: 0x4285F4, alpha: 1.0).CGColor,
                          UIColor(netHex: 0xDE3E35, alpha: 1.0).CGColor,
                          UIColor(netHex: 0xF7C223, alpha: 1.0).CGColor,
                          UIColor(netHex: 0x1B9A59, alpha: 1.0).CGColor,
                          UIColor(netHex: 0x4285F4, alpha: 1.0).CGColor]
